...
export class SignupPage {
  ...
  // botao de cadastro com sucesso
  showInsertOK(){
    let alert = this.alertCtrl.create({
      title: 'Sucesso!',
      message: 'Cadastro efetuado com sucesso',
      enableBackdropDismiss: false, //só sai quando clicar no botao
      buttons: [
        {
          text: 'OK',
          handler: () => {
            this.navCtrl.pop(); // desempilha a pagina de cadastro
          }
        }
      ]
    });
    alert.present(); // mostra o alerta na tela
  }
