...
export class PaymentPage {
  ...
  nextPage() {
    ...
    // vai para a pagina de confirmação do pedido
    this.navCtrl.setRoot('OrderConfirmationPage', {pedido: this.pedido}); // envia o obj {pedido: this.pedido} para outra pagina
  }
